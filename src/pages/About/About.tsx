...
const categories = [
  ...
  },
  {
    ...
    tools: [
      {
        name: "Inspire Designer",
        icon: (
          <img
            src={inspireIcon}
            alt="Quadient Inspire Designer"
            style={{ height: "2rem" }}
          />
        ),
        accent: "#00bcd4",
      ...
      },
      {
        name: "Notepad++",
        icon: (
          <img src={notepadppIcon} alt="Notepad++" style={{ height: "2rem" }} />
        ),
        accent: "#8ec641",
      },
      {
        name: "Microsoft Word",
        icon: (
          <img src={wordIcon} alt="Microsoft Word" style={{ height: "2rem" }} />
        ),
        accent: "#2b579a",
      },
      {
  ...
  },
  {
    ...
    tools: [
      ...
      {
        name: "C++",
        icon: <span style={{ fontSize: "2rem" }}>C++</span>,
        accent: "#00599c",
      },
      { name: "Java", icon: <FaJava />, accent: "#007396" },
      {
        name: "Kotlin",
        icon: <SiKotlin style={{ fontSize: "2rem" }} />,
        accent: "#7f52ff",
      },
...
export default function About() {
  ...
  const [animMode, setAnimMode] = useState<"none" | "breathing" | "wave">(
    "breathing",
  );
  ...
  useEffect(() => {
    ...
    if (!isSmallScreen) {
      ...
      const navbarHeight =
        (navbar && (navbar as HTMLElement).clientHeight) || 72;
    ...
    <div className={styles.aboutPage}>
      ...
      >
        ...
        <p className={styles.bio}>
          ...
          learning new technologies. Here are some of the technologies and tools
          I've worked with:
        </p>
        ...
        <div className={styles.modeSwitcher}>
          {modeOptions.map((opt) => (
            <button
              ...
              type="button"
              onClick={() =>
                setAnimMode(opt.key as "none" | "breathing" | "wave")
              }
          ...
          <ul className={styles.timeline}>
            <li>
              ...
              <div className={styles.timelineStart}>
                ...
                <p className={styles.eventText}>
                  ...
                  <strong>
                    <em>
                      FEU Institute of Technology, specializing in Web and
                      Mobile Application Development,
                    </em>
                  </strong>{" "}
                  with hands-on projects focused on creating responsive and
            ...
            <li>
              ...
              <div className={styles.timelineEnd}>
                ...
                <p className={styles.eventText}>
                  Worked as a Junior Systems Developer at{" "}
                  <strong>
                    <em>
                      FEU Institute of Technology – Information Technology
                      Services Office (ITSO)
                    </em>
                  </strong>{" "}
                  during Internship, contributing to the development of the
                  Associates Portal x HRIS.
                </p>
              </div>
            </li>
            <li>
              ...
              <div className={styles.timelineStart}>
                ...
                <p className={styles.eventText}>
                  Interned at{" "}
                  <strong>
                    <em>Convey Health Solutions</em>
                  </strong>
                  , where I created and maintained exhibits (automated letters)
                  using Quadient Products. Contributed to workflow automation,
                  built an Imaging File Mover, and assisted in QA testing to
                  improve efficiency and accuracy of document processes.
                </p>
              </div>
            </li>
            <li>
            ...
            <li className={styles.present}>
              ...
              <div className={styles.timelineStart}>
                ...
                <p className={styles.eventText}>
                  Co-founded and led the development of{" "}
                  <strong>
                    <em>Customodoro Timer</em>
                  </strong>
                  , a fully customizable Pomodoro timer web app designed to help
                  users improve focus, time management, and daily productivity.
                </p>
              </div>
            </li>
            <li className={styles.present}>
              ...
              <div className={styles.timelineEnd}>
                ...
                <p className={styles.eventText}>
                  ⚔️ Quest Unlocked: Red Gate Dungeon
                </p>
              </div>
            </li>
          </ul>

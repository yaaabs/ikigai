...
const techIconMeta: Record<
  string,
  { icon: React.ReactElement; color: string; url?: string }
> = {
  JavaScript: {
  ...
  "Android APK": {
    icon: <SiAndroid title="Android APK" />,
    color: "#3DDC84",
    url: "https://developer.android.com/",
  },
  EAS: {
    icon: <SiExpo title="EAS" />,
    color: "#000020",
...
const projects = [
  ...
  },
  {
    ...
    github: "",
    demo: "",
    tags: ["PHP", "Navicat for MySQL", "MySQL", "Bootstrap", "JavaScript"],
    fullDesc:
  ...
  },
  {
    ...
    tech: ["PHP", "JavaScript", "HTML5", "CSS", "Bootstrap", "MySQL"],
    image: fitcpr,
    images: [fitcpr2, fitcpr1],
    github: "",
    demo: "",
    tags: ["PHP", "HTML5", "JavaScript", "Bootstrap", "Web Development"],
    fullDesc:
  ...
  },
  {
    ...
    tags: ["TypeScript", "React"],
    fullDesc: `This is a DEMO APPLICATION ONLY created for interview/portfolio purposes. This is NOT an official Drink PH website and is not affiliated with, endorsed by, or representing any actual company named "Drink PH" or similar organizations. This is purely a fictional demonstration of web development capabilities.`,
  },
  {
    ...
    tags: ["React"],
    fullDesc: `Aifon Calculator is a cross-platform app built with React Native and Expo, designed to faithfully recreate the look and feel of the iPhone calculator. The PWA version is deployed live on Vercel for instant web access, while the Android build was packaged as an APK using the Expo SDK for mobile installation.`,
  },
  {
    ...
    tags: ["React", "Next.js"],
    fullDesc: `JericaMix is a modern, interactive portfolio website designed for a Multimedia Arts student, showcasing a stunning blend of creative design and technical expertise.`,
  },
  {
    ...
    tags: ["React", "Next.js"],
    fullDesc: `Originally crafted as a heartfelt gift for my sister’s birthday, this project grew into a freelance offering where I create personalized, interactive birthday websites for clients celebrating their loved ones.`,
  },
];
...
function useImgModal(
  ...
  setImgModal: React.Dispatch<
    React.SetStateAction<{ projectIdx: number; imgIdx: number } | null>
  >,
  imagesLength: number,
) {
  const modalRef = useRef<HTMLDivElement>(null);
        ...
        if (Math.abs(diff) > 50) {
          ...
          if (diff > 0) {
            ...
            setImgModal((modal) => ({
              projectIdx: modal ? modal.projectIdx : 0,
              imgIdx: modal
                ? (modal.imgIdx - 1 + imagesLength) % imagesLength
                : 0,
            }));
          }
        }
  ...
  return (
    <div className={styles.projectsPage}>
      ...
      <p className={styles.subheading}>
        A collection of real-world and personal projects I've developed during
        my internship, in college, and in my own time, each solving practical
        ...
        {majorTags.map((tag) => {
          ...
          return (
            <button
              key={tag}
              className={
                tagClass + (filter === tag ? " " + styles.activeFilter : "")
              }
            ...
            <div className={styles.cardContent}>
              ...
              <p className={styles.cardDesc}>
                {project.title === "Customodoro Timer" ? (
                  ...
                  <>
                    Lightweight QR generator for everyone |{" "}
                    <strong>Full-Stack Web Developer</strong>
                  </>
                  ...
                  <>
                    A cross-platform calculator app built with React Native and
                    Expo | <strong>Full-Stack Web Developer</strong>
                  </>
                ) : project.title === "Jericamix Portfolio" ? (
                  <>
                    A website portfolio showcasing a Multimedia Artist’s
                    projects. | <strong>Full-Stack Web Developer</strong>
                  </>
                ) : project.title === "Birthday Website Series" ? (
                  <>
                    A custom birthday web experience that turns celebrations
              ...
              >
                {(() => {
                  const techsWithIcons = project.tech.filter(
                    (t) => techIconMeta[t],
                  );
                  return (
                    <>
            ...
            >
              <div className={styles.marqueeItemContainer}>
                ...
                <div className={styles.marqueeItem}>
                  <img
                    src={feutechLogo}
                    alt="FEU Tech Capstone Project Repository"
                    className={styles.marqueeLogo}
                  />
                  <div className={styles.marqueeItemText}>
          ...
          >
            ...
            {filteredProjects[selected].title ===
              ...
              >
                ...
                />
                <span>
                  Please note that this is not the official website of the
                  school but a final project created for the course IT0129 IT
                  Elective - System Integration & Architecture 2.
                </span>
              </div>
            )}
              ...
              >
                <div>
                  ...
                  <div style={{ fontSize: "0.95rem", opacity: "0.9" }}>
                    • Best Web Application Capstone Project
                    <br />• Most Innovative Capstone Project
                  </div>
                </div>
              </div>
            )}
            <div style={{ height: "1.2rem" }} />{" "}
            {/* Safe vertical space, similar to <br> but for spacing */}
            ...
            <div style={{ height: "1.2rem" }} />{" "}
            {/* Spacer between tech stack and screenshots */}
                ...
                <div className={styles.slider}>
                  {filteredProjects[selected].images.map((img, i) => (
                    <img
                      ...
                      onClick={() =>
                        setImgModal({ projectIdx: selected, imgIdx: i })
                      }
                    />
                  ))}
                </div>
            ...
            <div className={styles.modalActions}>
              {filteredProjects[selected].github ? (
                ...
                <span
                  className={styles.actionBtnGray + " " + styles.githubBtn}
                  tabIndex={-1}
                  aria-disabled="true"
                >
                  <span className={styles.githubIcon}>
              ...
              {filteredProjects[selected].title === "Customodoro Timer" && (
                <a
                  ...
                  rel="noopener noreferrer"
                  className={
                    styles.actionBtnLinkedin + " " + styles.linkedinBtn
                  }
                >
              ...
              {filteredProjects[selected].demo ? (
                ...
                <span
                  className={styles.actionBtnGray + " " + styles.demoBtn}
                  tabIndex={-1}
                  aria-disabled="true"
                >
                  <span className={styles.demoIcon}>
      ...
      {imgModal !== null && (
        ...
        >
          ...
          >
              ...
              <button
                ...
                onMouseOver={(e) => {
                  e.currentTarget.style.background =
                    "linear-gradient(135deg, #232526 0%, #666 100%)";
                  e.currentTarget.style.boxShadow =
            ...
            <img
              src={
                filteredProjects[imgModal.projectIdx].images[imgModal.imgIdx]
              }
            ...
            <div
              style={{ color: "#fff", marginTop: "0.7rem", fontSize: "1rem" }}
            >
              {filteredProjects[imgModal.projectIdx].title} — Preview{" "}
              {imgModal.imgIdx + 1} /{" "}
              {filteredProjects[imgModal.projectIdx].images.length}
            </div>
          </div>
        </div>
      )}

...
const certifications = [
  ...
  {
    title:
      "Spying the Spectrum: Software-Defined Radio (SDR) Hackathon - Best Idea",
    date: "Nov 2023",
    image: bestideaImg,
    pdf: bestideaPdf,
    link: "",
  ...
  return (
    <section className={styles.achievementsSection}>
      ...
      <p className={styles.bio}>
        This section highlights some of the certifications, awards, and
        recognitions I’ve earned throughout my journey — reflecting both my
        technical growth and dedication to excellence in the field of software
        development.
      </p>

  ...
  return (
    <section className={styles.contactSection} id="contact">
          ...
          <div className={styles.featuredAppCard}>
            <div className={styles.featuredAppHeader}>
              ...
              <div>
                ...
                <div className={styles.featuredAppSubtitle}>
            ...
            <div className={styles.featuredAppDesc}>
              ...
              <span style={{ color: "#ff5a5a", fontWeight: 500 }}>
              ...
              {/* Add breathing space after button */}
            </div>
          </div>
          <div className={styles.detailItem}>
            <FaEnvelope className={styles.detailIcon} />
            <a
              href="mailto:brianyabutech@gmail.com"
      ...
      <div className={styles.resumeWrap}>
        <a href={RESUME_URL} download className={styles.btnSlide2}>
